...
const tel_nauwkeurig = ["Count accurately", "Genau zählen", "Doğru sayın", "Tel nauwkeurig", "Licz dokładnie", "Contar con precisión", "Räkna exakt", "Comptez avec précision", "точно подсчитывать", "Conta accuratamente", "准确计数", "正確に数える", "Conte com precisão"];
