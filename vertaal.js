...
const onderdeel_test = ["Experience the problem of perfection", "Erleben Sie die Probleme der Perfektion", "Mükemmellik sorunlarını deneyimleyin", "Ondervind de problematiek van perfectie", "Doświadcz problemów związanych z perfekcją", "Experimentar los problemas de la perfección", "Upplev problemen med perfektion", "Expérimenter les problèmes de la perfection", "Испытайте проблемы совершенства", "体验完美问题", "完璧さの問題を体験する", "Experimentar os problemas da perfeição" ];
